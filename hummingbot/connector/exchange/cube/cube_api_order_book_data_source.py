...
class CubeAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:
        ...
        snapshot_msg: OrderBookMessage = CubeOrderBook.snapshot_message_from_exchange_rest(
            snapshot,
            snapshot_timestamp,
    ...
    async def _parse_trade_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        ...
        for trades in raw_message["data"]:
            trade_message: OrderBookMessage = CubeOrderBook.trade_message_from_exchange(
    ...
    async def _process_ob_snapshot(self, snapshot_queue: asyncio.Queue):
        ...
        while True:
            try:
                ...
                order_book_message: OrderBookMessage = CubeOrderBook.snapshot_message_from_exchange_websocket(
